...
export default function Report() {
    ...
    const handleDownloadExcel = async () => {
        ...
        if (ticketCategorySummary) {
            ...
            addTable("Hardware Tickets", ["ID", "Problem/Issue", "Status", "Type", "Assigned To", "For", "Created At"],
                filteredTickets.filter(t => t.ticket_category === "hardware").map(t => [
                    t.ticket_id, t.ticket_subject, t.ticket_status, t.ticket_type,
                    t.assigned_to || "-", t.ticket_for || "-", new Date(t.created_at).toLocaleString()
                ])
            );
            addTable("Network Tickets", ["ID", "Problem/Issue", "Status", "Type", "Assigned To", "For", "Created At"],
                filteredTickets.filter(t => t.ticket_category === "network").map(t => [
                    t.ticket_id, t.ticket_subject, t.ticket_status, t.ticket_type,
                    t.assigned_to || "-", t.ticket_for || "-", new Date(t.created_at).toLocaleString()
                ])
            );
            addTable("Software Tickets", ["ID", "Problem/Issue", "Status", "Type", "Assigned To", "For", "Created At"],
                filteredTickets.filter(t => t.ticket_category === "software").map(t => [
                    t.ticket_id, t.ticket_subject, t.ticket_status, t.ticket_type,
                    t.assigned_to || "-", t.ticket_for || "-", new Date(t.created_at).toLocaleString()
                ])
            );
            addTable("System Tickets", ["ID", "Problem/Issue", "Status", "Type", "Assigned To", "For", "Created At"],
